...
const pluginId = 'cleverdialerukPlugin';

// Plugin information
const pluginInfo = {
  // Plugin information
  info: {
    id: 'cleverdialerukPlugin', // Plugin ID, must be unique, changed to shouldianswer
    name: 'cleverdialerUK', // Plugin name, changed to Should I Answer (based on the website name)
...
function queryPhoneInfo(phoneNumber, requestId) {
  ...
  FlutterChannel.postMessage(JSON.stringify({
    ...
    method: 'GET',
    requestId: requestId,
    url: `https://www.cleverdialer.co.uk/phonenumber/${phoneNumber}`,
    headers: {
