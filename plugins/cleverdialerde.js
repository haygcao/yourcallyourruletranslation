...
const pluginId = 'cleverdialerdePlugin';

// Plugin information
const pluginInfo = {
  // Plugin information
  info: {
    id: 'cleverdialerdePlugin', // Plugin ID, must be unique, changed to shouldianswer
    name: 'cleverdialerDE', // Plugin name, changed to Should I Answer (based on the website name)
...
function queryPhoneInfo(phoneNumber, requestId) {
  ...
  FlutterChannel.postMessage(JSON.stringify({
    ...
    method: 'GET',
    requestId: requestId,
    url: `https://https://www.cleverdialer.de/telefonnummer/${phoneNumber}`,
    headers: {
