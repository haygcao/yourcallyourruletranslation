...
const pluginId = 'cleverdialeratPlugin';

// Plugin information
const pluginInfo = {
  // Plugin information
  info: {
    id: 'cleverdialeratPlugin', // Plugin ID, must be unique, changed to shouldianswer
    name: 'cleverdialerAT', // Plugin name, changed to Should I Answer (based on the website name)
...
function queryPhoneInfo(phoneNumber, requestId) {
  ...
  FlutterChannel.postMessage(JSON.stringify({
    ...
    method: 'GET',
    requestId: requestId,
    url: `https://www.cleverdialer.at/telefonnummer/${phoneNumber}`,
    headers: {
